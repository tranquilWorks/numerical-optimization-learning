# P19 checks: Compute Sensitivity to Inputs
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you compute Sensitivity to Inputs?” without relying on MATLAB syntax.
