# P20 checks: Propagate Uncertainty by Monte Carlo
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you propagate Uncertainty by Monte Carlo?” without relying on MATLAB syntax.
