# P24 checks: Verify a Solver Against Independent Checks
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you verify a Solver Against Independent Checks?” without relying on MATLAB syntax.
