# Repository instructions — Numerical Methods and Optimization

## Product purpose

This repository is the **Numerical Methods and Optimization** interactive MATLAB learning system, not a collection of disconnected demos. Teach concepts through controlled experiments, notebook-style sections, plots, parameter levers, deliberately broken cases, and concise dialogue.
